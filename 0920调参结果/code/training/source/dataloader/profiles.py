...
def transform_trace_row(sample_id, epoch, rank, worker_id, transform):
    cropped_height = min(
...
def trace_comparison_profile(
    ...
    *,
    ...
    """Synthetic RNG unit helper; it is not three-arm DataLoader evidence."""
    ...
    for sample_id in sample_ids:
        ...
        rows.append(transform_trace_row(sample_id, epoch, rank, 0, transform))
