#!/usr/bin/env python3
"""Run the authorized two-arm suite sequentially with resource protection."""
...
from suite_common import validate_shared
...
def validate_train_prerequisites(suite, suite_path=None):
    ...
    if suite.get('baseline_initial_model_sha256') and next(iter(hashes)) != suite['baseline_initial_model_sha256']:
        raise SuiteFailure("FAIL", "GAMMA2_BASELINE_INITIALIZATION_MISMATCH", reports)
