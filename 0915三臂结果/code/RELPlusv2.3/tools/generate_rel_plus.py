#!/usr/bin/env python3
"""Generate one canonical Stanford2D3D S2D REL+ v2.1 PNG."""
...
def main():
    ...
    raw_depth, camera, source_shape = load_canonical_frame(
        args.depth, args.camera_json, dataset_profile=STANFORD_S2D_PROFILE
    )
    rel_plus, debug = generate_rel_plus_v2_1(raw_depth, camera, return_debug=True)
