...
> Historical attempt1 report. Attempt1 exited 1 after epoch 105 while preparing
> the second formal checkpoint. Attempt2 resumed from the complete epoch-100
> checkpoint on 2026-08-25. The current evidence is in
> `FORMAL_TRAINING_RECOVERY_REPORT.md`.

## Status

`FAIL` (attempt1; superseded by authorized attempt2 recovery)
