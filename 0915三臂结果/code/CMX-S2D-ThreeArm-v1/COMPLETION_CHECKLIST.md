...
- [x] 唯一 seed 12345、8-GPU、200-epoch Original CMX REL+ 正式训练已
  启动，并确认前 150 次更新稳定。
- [x] attempt1 checkpoint-link 失败已保留；epoch-100 checkpoint 的模型、
  optimizer、epoch 和 iteration 已核验。
- [x] 第二次 checkpoint 的合法日志软链接回归测试 RED 后 GREEN；最终
  live-source 回归 126 passed。
- [x] attempt2 已从 epoch 100 恢复，8 ranks 存活并完成至少 100 次新
  optimizer update。
