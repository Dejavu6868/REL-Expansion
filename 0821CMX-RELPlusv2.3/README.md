...
Runtime status on 2026-08-21: `FORMAL_TRAINING_STARTED`. Full cache, complete
audit, complete training-data preflight and the real 8-rank 50+3-update DDP
smoke are PASS. The only authorized seed-12345 formal run was observed through
150 stable optimizer updates; 200 epochs and scientific evaluation are not yet
complete. See `FORMAL_TRAINING_LAUNCH_REPORT.md` for the evidence boundary.
