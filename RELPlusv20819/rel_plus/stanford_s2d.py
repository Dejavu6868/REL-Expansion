...
from .constants import REL_PLUS_V2_CANONICAL_SHAPE
from .depth import resize_raw_depth_nearest


def load_canonical_frame(
    depth_path, camera_json_path, canonical_shape=REL_PLUS_V2_CANONICAL_SHAPE
):
    ...
    camera = load_stanford_s2d_camera_geometry(camera_json_path, source_shape)
    camera.assert_matches_image_shape(source_shape)
