...
def main(argv=None):
    ...
    try:
        ...
        if tuple(suite.get("arms", [])) != ARMS:
            raise RuntimeError("Suite must specify the ordered arms rgbd, hha, relplus")
        ...
        for arm in ARMS:
            ...
            if baseline_ids is None:
                ...
                raise RuntimeError("The three arms do not share identical ordered train/test IDs")
            ...
            if baseline_sampler is None:
                ...
                raise RuntimeError("Three-arm epoch 1/2 sampler sequences differ")
