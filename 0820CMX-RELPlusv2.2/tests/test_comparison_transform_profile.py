...
def test_synthetic_rng_helper_matches_but_is_not_real_loader_evidence():
    ...
    assert set(traces["rgbd"][0]) == {
        "sample_id", "epoch", "rank", "worker_id", "scale", "crop_top", "crop_left",
        "scaled_height", "scaled_width", "output_height", "output_width",
