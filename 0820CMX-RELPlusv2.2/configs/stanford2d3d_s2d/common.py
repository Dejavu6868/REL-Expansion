...
def base_config(
    *,
    ...
    c.integration_protocol_id = protocol_id
    ...
    c.dataset_split = "Stanford2D3D_S2D_official_train_test"
    c.dataset_fold = None
    ...
    c.log_dir_link = osp.join(output_root, "latest_{}_logs".format(output_name))
